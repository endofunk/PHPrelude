...
use Endofunk\Core\Exception\ElementNotFoundException;
use Endofunk\Core\Exception\IncompletePatternMatchException;
use Endofunk\Core\Exception\InvalidPatternMatchException;
