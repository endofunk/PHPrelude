...
namespace Endofunk\Core;

use Endofunk\Core\Exception\FunctionNotFoundException;
...
abstract class Module {
	 ...
	 * Endo functions that is more akin to native PHP.
	 *
	 ...
	 * Function Arity
	 *
	 * Returns the arity of a function, e.g. the number of arguments it
